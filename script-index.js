...
const AudioManager = {
    ...
    init(settings) {
        ...
        // Música de Fondo
        this.music = new Audio('data:audio/mp3;base64,SUQzBAAAAAAAI1RTU0UAAAAPAAADTGF2ZjU4LjQ1LjEwMAAAAAAAAAAAAAAA//tAwAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA');
    ...
    startMusic() {
        if (this.music && this.settings.masterVol > 0) {
